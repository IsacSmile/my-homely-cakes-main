  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 overflow-y-auto">
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-5 py-3.5 bg-bakery-chocolate text-white shrink-0 print:hidden">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-serif text-sm font-bold tracking-wide">Thermal Receipt Preview</h3>
          </div>
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={handlePrint}
              className="inline-flex items-center gap-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold text-xs px-3 py-1.5 rounded-lg shadow-xs transition-all active:scale-95 cursor-pointer"
            >
        ...
        <div className="p-6 overflow-y-auto bg-slate-100 flex justify-center print:hidden">
      ...
      <div id="printable-receipt" className="hidden print:block text-[11px] leading-tight text-black bg-white">
        ...
        {/* Footer */}
        <div style={{ textAlign: 'center', fontSize: '10px', paddingTop: '2px' }}>
