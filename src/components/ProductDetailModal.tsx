          ...
          <div className="p-8 w-full flex flex-col items-center justify-center text-center space-y-6 bg-bakery-50">
            ...
            <div>
              ...
              <p className="text-sm text-bakery-800">
                Order Reference: <strong className="font-price font-medium text-amber-800 font-mono">{orderSuccess.orderNumber}</strong>
              </p>
            </div>
          ...
          <>
            ...
            <div className="w-full md:w-1/2 p-5 sm:p-6 overflow-y-auto max-h-[85vh] flex flex-col justify-between space-y-4">
              <div>
                ...
                {/* Weight Variant Selector showing exact admin prices in Montserrat medium weight */}
                    ...
                    {variantsList.map((v: WeightVariant) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={`font-price text-[11px] font-medium ${isSelected ? 'text-amber-100' : 'text-amber-800'}`}>
                            {formatINR(v.price)}
                          </span>
                        </button>
                      );
                ...
                {/* Price Display in Montserrat font-price Medium */}
                <div className="mt-4 p-3.5 bg-bakery-softBg rounded-2xl border border-amber-200/60 flex items-center justify-between">
                  <div>
                    ...
                    <span className="font-price text-xl sm:text-2xl font-medium text-amber-800 tracking-tight">
