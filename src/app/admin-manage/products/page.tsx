...
export default function AdminProductsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!name || !description || !imageUrl || !basePrice) return;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-bakery-600">
            Add new cakes, set base weight/price, define weight variants, and toggle stock availability.
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {productsList.map((product) => (
            ...
            >
              <div className="relative aspect-16/9 w-full bg-bakery-100">
                <Image
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
          <div className="bg-white w-full max-w-xl max-h-[90vh] rounded-3xl p-6 overflow-y-auto space-y-4 shadow-2xl relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="text-xs font-bold text-bakery-800 block mb-1">Image URL (Unsplash or Remote) *</label>
                <input
                  type="url"
                  required
                  value={imageUrl}
